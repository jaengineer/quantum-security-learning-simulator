...
export const TELEPORTATION_UI_STRINGS = {
  ...
  previous_step: { en: "Previous", es: "Anterior" },
  next_step: { en: "Next", es: "Siguiente" },
  step_counter: { en: "Step", es: "Paso" },
  of: { en: "of", es: "de" },
  relevant_gates: { en: "Relevant gates", es: "Puertas relevantes" },
  alice_input: { en: "Alice input", es: "Entrada de Alice" },
  bob_recovered: { en: "Bob recovered", es: "Bob recuperado" },
  bob_uncorrected: { en: "Bob before correction", es: "Bob antes de corregir" },
  classical_message_sent: {
    en: "Classical message sent to Bob",
    es: "Mensaje clásico enviado a Bob",
  },
  branch_probability: { en: "Branch probability", es: "Probabilidad de rama" },
  protocol_hint: {
